...
export const slides = [
  {
    tag: "Sales Enablement Deck · US",
    title: "Vakil Case",
    subtitle: "The all-in-one practice management platform for modern American law firms — cases, clients, billing, documents, and trust accounting in one secure workspace.",
    content: (
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 text-indigo-600 font-semibold">
            <Scale className="w-5 h-5" /> Built for US legal professionals
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 pt-2">
            ...
            <Stat value="100%" label="USD billing" />
  ...
  },
  {
    ...
    content: (
      <div className="grid md:grid-cols-3 gap-5">
        ...
        <FeatureCard icon={Receipt} title="Billing & Invoices" desc="Generate, send, and track invoices — fully in USD with partial-payment tracking." />
        ...
        <FeatureCard icon={Landmark} title="Trust Accounting" desc="Separate trust and operating accounts (IOLTA-ready) with full transaction ledgers." />
      </div>
    ),
  },
  {
        ...
        <div className="lg:col-span-2">
          <MiniAppFrame active="Dashboard" title="Dashboard">
            <div className="grid grid-cols-4 gap-3">
              ...
              <KPICard label="Pending $" value={usd(42000)} color="rose" />
            </div>
            <div className="mt-4">
              <MiniTable
                headers={["Case", "Client", "Status", "Next hearing"]}
                rows={[
                  ["Carter v. Pierce", "Emily Carter", <Pill tone="indigo">Trial</Pill>, "Sep 12"],
                  ["Estate of Williams", "Sophia Bennett", <Pill tone="amber">Discovery</Pill>, "Sep 18"],
                  ["Meridian Corp. Merger", "Meridian Industries", <Pill tone="emerald">Filed</Pill>, "—"],
                ]}
              />
            </div>
          </MiniAppFrame>
        ...
        <div className="lg:col-span-2">
          <MiniAppFrame active="Clients" title="Clients">
            <MiniTable
              ...
              rows={[
                ["Emily Carter", "emily.carter@email.com", "+1 415...", <Pill tone="emerald">Active</Pill>, "E. Davis"],
                ["Sophia Bennett", "sophia.b@email.com", "+1 212...", <Pill tone="indigo">Onboarded</Pill>, "S. Martinez"],
                ["Meridian Industries", "legal@meridian.co", "+1 312...", <Pill tone="amber">Prospect</Pill>, "E. Davis"],
              ]}
            />
          </MiniAppFrame>
        </div>
        ...
        <div className="lg:col-span-2">
          <MiniAppFrame active="Cases" title="Cases">
            <MiniTable
              ...
              rows={[
                ["Carter v. Pierce", "Civil Litigation", <Pill tone="indigo">Trial</Pill>, <Pill tone="rose">Urgent</Pill>, "Emily Carter"],
                ["Estate of Williams", "Estate Planning", <Pill tone="amber">Discovery</Pill>, <Pill tone="amber">High</Pill>, "Sophia Bennett"],
                ["Meridian Corp. Merger", "Corporate", <Pill tone="emerald">Filed</Pill>, <Pill>Medium</Pill>, "Meridian Industries"],
              ]}
            />
          </MiniAppFrame>
        </div>
  ...
  },
  {
    ...
    subtitle: "Profiles, state bar credentials, specializations, ratings, and verification status.",
    content: (
      <div className="grid lg:grid-cols-3 gap-6 items-center">
        <div className="lg:col-span-2">
          <MiniAppFrame active="Lawyer Management" title="Lawyer Management">
            <MiniTable
              ...
              rows={[
                ["Attorney Emily Davis", "Criminal Law", "CA #246813", "12", <Pill tone="emerald">Verified</Pill>],
                ["Attorney Sophia Martinez", "Family Law", "NY #135790", "8", <Pill tone="amber">Under Review</Pill>],
                ["Attorney Marcus Lee", "Corporate", "DE #987654", "15", <Pill tone="emerald">Verified</Pill>],
              ]}
            />
          </MiniAppFrame>
        </div>
        <div className="space-y-3 text-sm text-slate-600">
          <TalkPoint n="1" t="State bar credentials" d="Bar number and state bar association on every profile." />
  ...
  },
  {
    ...
    title: "Billing that gets you paid — in USD",
        ...
        <div className="lg:col-span-2">
          <MiniAppFrame active="Invoices" title="Invoices">
            <MiniTable
              ...
              rows={[
                ["INV-1042", "Emily Carter", usd(1250), usd(1250), <Pill tone="emerald">Paid</Pill>, "—"],
                ["INV-1043", "Sophia Bennett", usd(2400), usd(1200), <Pill tone="amber">Partial</Pill>, "Sep 20"],
                ["INV-1044", "Meridian Industries", usd(5500), usd(0), <Pill tone="rose">Overdue</Pill>, "Sep 01"],
              ]}
            />
          </MiniAppFrame>
        </div>
        <div className="space-y-3 text-sm text-slate-600">
          <TalkPoint n="1" t="Native USD billing" d="All invoices and trust ledgers in US Dollars." />
  ...
  },
  {
    ...
    content: (
      <div className="grid md:grid-cols-2 gap-5">
        <FeatureCard icon={Landmark} title="Trust Accounting (IOLTA)" desc="Separate trust and operating accounts with full deposit/withdrawal ledgers and running balances." />
      ...
      <div className="grid md:grid-cols-2 gap-6 items-center">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            <SecurityItem icon={DollarSign} t="USD-only billing" d="Currency consistency" />
  ...
  {
    tag: "Why Vakil Case",
    title: "Built for US law firms, ready to scale",
    subtitle: "Purpose-built for the way American attorneys actually work.",
    content: (
      <div className="grid md:grid-cols-3 gap-5">
        <FeatureCard icon={DollarSign} title="USD-native" desc="Every amount — fees, trust, retainers, subscriptions — in US Dollars." />
        <FeatureCard icon={Globe} title="Multi-state ready" desc="US-first with templates and fields tuned for state bars and US courts." />
        ...
        <FeatureCard icon={Building2} title="Firm-ready" desc="From solo attorneys to multi-lawyer firms." />
